      ...
      <div className="pt-20 pb-8 px-4 md:px-8">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-orbitron text-foreground">NEO Dashboard</h1>
          </div>
          <div className="flex items-center gap-4">
            <motion.button
          ...
          >
            <div className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-4">
              <p className="text-sm text-muted-foreground font-rajdhani mb-4">
                The list of Asteroids below are segregated by date, based on their closest approach date to Earth
              </p>
              <MonthSelector
            ...
            <div className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-4 h-full">
              <div className="flex items-center justify-between mb-4">
                <p className="text-sm text-muted-foreground font-rajdhani">
                  Scroll down for a complete list of Asteroids. Click on an archive button for more NEOs
                </p>
